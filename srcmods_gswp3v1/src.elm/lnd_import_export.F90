          ...
          do v=1,met_nvars
            ...
            if (atm2lnd_vars%metsource == 0) then 
               ...
               metdata_fname = 'Princeton_' // trim(metvars(v)) // '_1901-2012_z' // zst(2:3) // '.nc'
                ...
                metdata_fname = 'GSWP3.c2011.0.5x0.5_' // trim(metvars(v)) // '_1901-2010_z' // zst(2:3) // '.nc'
                if (use_livneh .and. ztoget .ge. 16 .and. ztoget .le. 20) then 
            ...
            !write(iulog,*) ierr, "error code while opening input meteorology file"
            !write(iulog,*) metdata_ '/' trim(metdata_fname)
