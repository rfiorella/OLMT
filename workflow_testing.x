...
if ($case == 1) then
  ...
  python3  ./global_fullrun.py --compiler gnu --mpilib openmpi --machine ees --caseidprefix test7 \
  ...
  python3  ./global_fullrun.py --compiler gnu --mpilib openmpi --machine ees --caseidprefix test8 \
