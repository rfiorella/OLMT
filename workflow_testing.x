...
if ($case == 1) then
  python3 ./site_fullrun.py --compiler gnu --mpilib openmpi --machine lanl-ees --site US-UMB --sitegroup AmeriFlux 
else if ($case == 2) then
  python3 ./site_fullrun.py --compiler gnu --mpilib openmpi --machine lanl-ees --site AK-TLG --sitegroup NGEEArctic \
         ...
         --landusefile /project/neon_e3sm/inputdata/lnd/clm2/surfdata_map/landuse.timeseries_1x1pt_teller-GRID_simyr1850-2015_c180423.nc --nofire --no_budgets --spinup_vars --nopointdata
else if ($case == 3) then
python3 ./global_fullrun.py --compiler gnu --mpilib openmpi --machine lanl-ees --caseidprefix Yukon \
        --nopftdyn --nofire --nopointdata --dailyrunoff --caseidprefix test \
